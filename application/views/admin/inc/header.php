...
<body class="fixed-navbar fixed-sidebar">
    ...
    <div id="header">
        ...
        <div id="logo" class="light-version">
            <span>
                <a href="<?=base_url()?>" target="_blank">ciu.edu.ge</a>
            </span>
        </div>
        <nav role="navigation">
                                ...
                                <tr>
                                    <td>
                                        <a href="<?=site_url('admin/poll')?>">
                                            <i class="pe pe-7s-graph text-info"></i>
                                            <h5>გამოკითხვა</h5>
                                        </a>
                                    </td>
                                    <td>
        ...
        <div id="navigation">
            <div class="profile-picture">
                <a href="/" target="_blank">
                    <img src="/public/assets/images/ciu-logo.png" alt="logo" width="80px">
                </a>
            </div>
            ...
            <ul class="nav" id="side-menu">
                ...
                <li class="<?php if($this->uri->segment(2) == 'academic_staff') echo "active"; ?>">
                    <a href="<?=site_url('admin/academic_staff')?>"> <span class="nav-label">აკადემიური საბჭო</span> </a>
                </li>
