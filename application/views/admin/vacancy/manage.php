        ...
        <div class="col-lg-12">
            <div class="hpanel">
                <div class="panel-heading">
                    <a href="<?=site_url('admin/vacancy')?>/create" class="btn btn-primary">
                        <i class="fa fa-plus"></i> დამატება
                    </a>
                </div>
                <div class="panel-body">
                    <form action="<?=site_url('admin/vacancy')?>" method="get" class="hpanel clearfix">
                    ...
                    <div class="table-responsive">
                        <table id="dataTable" class="table table-striped table-bordered table-hover" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="6">შედეგი ვერ მოიძებნა!</td>
                                </tr>
                                <?php } ?>
