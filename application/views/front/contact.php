                	...
                	<div class="contact-info-block">
	                	<div class="uk-width-1-1">
	                		<div class="contact-info">
		                		...
		                		<?php foreach ($contact['phone'] as $value): ?>
			                    	<p>
	                	...
	                	<div class="uk-width-1-1">
		                	<div class="contact-info">	
		                		...
		                		<?php foreach ($contact['email'] as $value): ?>
			                    	<p>
	                	...
	                	<div class="uk-width-1-1">
		                	<div class="contact-info">	
		                    	...
		                    	<div class="contact-info-text-last contact-info-text">
			                		<?php foreach ($contact['bus_'.LANG] as $value): ?>
				                    	<p><?=$value?></p>
			                		<?php endforeach ?>
			                    </div>
		                    </div>	
