...
class All_vacancy extends CI_Controller {
	
	function __construct() {
		parent::__construct();
		$this->load->model(array('Front_model', 'Front_vacancy_model'));
	}
	...
	public function index()
	{
		...
		$data['vacancy_categories'] = $this->Front_vacancy_model->vacancy_categories();
		$this->load->view('front/all_vacancy', $data);
	}

	public function filter()
	{
		if(!empty($this->input->post())) {
			$data = $this->Front_vacancy_model->filter();
