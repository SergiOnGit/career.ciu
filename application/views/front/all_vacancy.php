<?php $this->load->view('front/inc/header.php'); ?>
    ...
    <div class="wrap pages-header-wrap">
        <ul class="uk-breadcrumb">
            ...
            <li><a href="/all_vacancy" class="uk-active">ყველა ვაკანსია</a></li>
        </ul>
        <header class="pages-header filters"> 
            <h2 class="pages-heading">
                <?=$translate['all_vacancy']?> <b id="news-chosen-cat"></b>
            </h2>
        ...
        <div class="uk-width-small-1-2 uk-width-medium-1-3 uk-width-large-1-5">
            <div class="news-card">
                <div class="news-card-img-wrap">
                    <a href="/vacancy/index/{{slug_<?=LANG?>}}">
                ...
                <div class="news-card-info-wrap">
                    ...
                    <div class="news-card-tags-wrap">
                        {{#categories}}
                        <a href="/all_vacancy?cat={{id}}" class="news-card-tags" style="color: #{{color}};">
                            {{title_<?=LANG?>}}
                        </a>
                        {{/categories}}
                    </div>
