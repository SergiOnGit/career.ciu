...
class Personal extends CI_Controller {
	...
	public function index()
	{
		...
		$data['faculties'] = $this->Front_personal_model->faculties();
		$data['directions'] = $this->Front_personal_model->directions();
		...
		$this->load->view('front/personal', $data);
	}

	public function filter()
	{
		if(!empty($this->input->post())) {
			$data = $this->Front_personal_model->filter();
