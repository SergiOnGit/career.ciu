...
class Vacancy_cats_ad_model extends CI_Model {
	...
	public function update_sorting() {
		$vacancy_cats_data = $this->input->get('vacancy_cats');

		foreach ($vacancy_cats_data as $key) {
